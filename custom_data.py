...
def main(args):
    ...
    for cat in tqdm(range(8)):
        ...
        for fold in tqdm(range(10), leave=False):
            ...
            model = retrieve_model(args['model_type'], len(encode_dict) + 2, cat, fold, args['chord_encoding'], device)
            data_set_scores = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_file', type=str, default="predictions.csv")
